            ...
            pill.addEventListener("click", (e) => {
                ...
                if (transTable) {
                    ...
                    if (table_name === "Pending") {
                        ...
                        PendingSortModal.forEach(({ labelText, inputId, checked }) => {
                        ...
                        EligibleSortModal.forEach(({ labelText, inputId, checked }) => {
                            // Create the label element
                            const label = document.createElement("label");
                        ...
                        RefundSortModal.forEach(({ labelText, inputId, checked }) => {
                            // Create the label element
                            const label = document.createElement("label");
