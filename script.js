(async () => {
    ...
    const radios = document.getElementsByName("sort_type");
    const sortModal = document.querySelectorAll(".sortModal");
    ...
    if (sortBtn) {
        sortBtn.addEventListener("click", (e) => {
            e.stopPropagation();
            sortModal[1]?.classList?.toggle("hide");
        });
    }
    radios.forEach((ele) => {
